...
@section('content')
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-2">
        ...
        <div class="flex mt-6">
            <h2 class="font-semibold text-xl">Add Content Client</h2>
        </div>

        <div class="mt-4" x-data="{ imageUrl: '/storage/noimage.png' }">
            <form enctype="multipart/form-data" method="POST" action="{{ route('client.store') }}" class="flex gap-8">
                @csrf
                ...
                <div class="w-1/2">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="slug" class="block mt-1 w-full" type="text" name="slug"
                            :value="old('slug')" x-mask:dynamic="$money($input, ',')" required />
