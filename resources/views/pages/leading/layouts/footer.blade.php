<footer class="bg-white dark:bg-gray-800">
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <!-- Col 1: Logo, Deskripsi, Alamat, Sosial Media -->
            <div>
                <a href="{{ url('/') }}" class="flex items-center mb-4">
                    <img src="./images/logo.svg" class="h-8 mr-2" alt="{{ $profile->first_name ?? 'Company' }} Logo" />
                    <span class="text-xl font-bold text-gray-900 dark:text-white">{{ $profile->first_name ?? 'Company' }}</span>
                </a>
                ...
                @if($profile)
                <div class="mb-4">
                    <h4 class="mb-2 text-sm font-semibold text-gray-900 dark:text-white">Alamat</h4>
            ...
            <!-- Col 2: Company -->
            <div>
                <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">{{ $profile->first_name ?? 'Company' }}</h3>
                <ul class="text-gray-500 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="{{ url('/') }}" class="hover:underline">Home</a>
                    </li>
                    <li class="mb-4">
                        <a href="{{ url('/') }}#wepper-content2" class="hover:underline">Visi & Misi</a>
                    </li>
                    <li class="mb-4">
            ...
            <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mb-4">
                        <a href="{{ url('/') }}#client" class="hover:underline">Clients</a>
                    </li>
                    <li class="mb-4">
                        <a href="{{ url('/contact-us') }}" class="hover:underline">Contact Us</a>
                    </li>
        ...
        <p class="text-sm text-center text-gray-500 dark:text-gray-400">&copy; {{ date('Y') }} {{ $profile->first_name ?? 'Company' }}. All rights reserved.</p>
    </div>
</footer>
