...
<div x-data="{saveProfile(){
            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $profile->country }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $profile->code }}</p>
                    </div>

                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">TAX ID</p>
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $profile->tax }}</p>
                    </div>
                </div>
            </div>
    ...
    <x-ui.modal x-data="{ open: false }" @open-profile-address-modal.window="open = true" :isOpen="false" class="max-w-[700px]">
        <div
            ...
            <form action="{{ route('pages.profile.update') }}" method="POST" class="flex flex-col">
                @csrf
                @method('PUT')
